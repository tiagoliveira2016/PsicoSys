...
--
-- Host: 127.0.0.1
-- Generation Time: 20-Maio-2019 às 03:50
...
CREATE TABLE `tab_disponibilidade` (
  `DISP_PROF` int(11) NOT NULL,
  `DISP_DIASEMANA` varchar(50) DEFAULT NULL,
  `DISP_HORAINI` datetime NOT NULL,
  `DISP_HORAFIN` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(18, 'JOSE PEDRO LUIZ', '2018-12-07 09:00:00', '2018-12-07 09:30:00', 17, 34, NULL, NULL, NULL, NULL, 'A', 1, 2),
(19, 'CLAUDIO LIMA SANTOS', '2018-12-07 08:00:00', '2018-12-07 08:30:00', 16, 35, NULL, NULL, NULL, NULL, 'A', 1, 1),
(20, 'JOSE PEDRO LUIZ', '2019-03-21 21:44:00', '2019-03-21 22:14:00', 17, 34, NULL, NULL, NULL, NULL, 'A', 1, 1),
(21, 'KASSIANA BARBOSA DO NASCIMENTO', '2019-05-14 22:00:00', '2019-05-14 22:30:00', 17, 33, NULL, NULL, NULL, NULL, 'A', 1, 1);
...
(1, 'LUCAS', 'LUCAS@PSICOSYS.COM.BR', '1234', 'off', 'Administrativo', '2018-12-06 01:34:41', 'ADMIN', '2018-12-06 20:00:00', 'LUCAS'),
...
--
ALTER TABLE `tab_disponibilidade`
  MODIFY `DISP_PROF` int(11) NOT NULL AUTO_INCREMENT;
--
